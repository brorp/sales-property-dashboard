...
export default function LeadSourcesPage() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (editingId) {
                ...
                successMessage = 'Sumber lead berhasil diupdate.';
            } else {
                ...
                successMessage = 'Sumber lead berhasil ditambahkan.';
            }
    ...
    const handleDelete = async (sourceId) => {
        ...
        const confirmed = window.confirm('Hapus sumber lead ini dari daftar pilihan? Lead lama tetap menyimpan source historisnya.');
        if (!confirmed) {
            return;
        }
        ...
        <div className="page-container">
            ...
            <div className="card settings-card">
                ...
                {!loading && sortedSources.length === 0 ? (
                    <p className="settings-help">Belum ada sumber leads untuk workspace ini.</p>
                ) : null}
                {!loading && sortedSources.length > 0 ? (
